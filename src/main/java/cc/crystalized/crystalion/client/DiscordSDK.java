...
public class DiscordSDK {
    ...
    //I stoll this from Tubion lol

    public static Logger LOGGER = LoggerFactory.getLogger("Crystalion/Discord");

    public static void loadSDK() {
        LOGGER.info("[SDKInitializer] Loading Discord GameSDK v3.2.1");
        File home = new File("config/crystalion/discord");
        ...
        File sdk = new File("config/crystalion/discord/" + fileName);
        File jni = new File("config/crystalion/discord/" + (SystemUtils.IS_OS_WINDOWS ? "discord_game_sdk_jni.dll" : "libdiscord_game_sdk_jni" +
    ...
    private static void downloadSDK(File sdk, String fileName) throws IOException {
        ...
        connection.setRequestProperty("User-Agent", "Crystalizon/discord");
    ...
    private static void loadNative(File sdk, File jni) {
        ...
        LOGGER.info("[SDKInitializer] Discord GameSDK Library 3.2.1 initialized");
    }
}
